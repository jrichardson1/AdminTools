...
\c system sqoop sqoop
create database travel;
create database us;

-- ----------------------------------------------------------------------------
\c travel sqoop sqoop
...
CREATE TABLE staging_cities as select * from cities
DISTRIBUTE ON RANDOM
;
...
CREATE TABLE cities as select * from  travel..cities WHERE country = 'USA'
DISTRIBUTE ON RANDOM
;

-- Populate data in us.cities from cities
-- INSERT INTO us.cities SELECT * FROM travel.cities WHERE country = 'USA';
